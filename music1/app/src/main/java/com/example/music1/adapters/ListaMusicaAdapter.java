...
public class ListaMusicaAdapter extends RecyclerView.Adapter<ListaMusicaAdapter.ViewHolder> {
    ...
    public ListaMusicaAdapter(List<Cancion> canciones, OnItemClickListener listener) {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(final Cancion cancion, final OnItemClickListener listener, Context context) {
            ...
            view.setOnClickListener(v -> listener.onItemClick(cancion));
        }
    }
}